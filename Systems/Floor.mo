...
model Floor
  ...
  parameter Modelica.SIunits.Pressure PreDroCoiAir "Pressure drop in the air side";
  parameter Modelica.SIunits.Pressure PreDroMixingBoxAir "Pressure drop in the air side";
  parameter Modelica.SIunits.Pressure PreDroCooWat "Pressure drop in the water side";
  ...
  parameter Modelica.SIunits.Pressure SupPreCur[:] "Supply Fan Pressure curve";
  parameter Modelica.SIunits.Pressure RetPreCur[:] "Return Fan Pressure curve";
  ...
  parameter Modelica.SIunits.Pressure PreWatDroMai1 "Pressure drop 1 across the pipe";

  parameter Modelica.SIunits.Pressure PreWatDroMai2 "Pressure drop 2 across the main pipe";

  parameter Modelica.SIunits.Pressure PreWatDroMai3 "Pressure drop 3 across the main pipe";

  parameter Modelica.SIunits.Pressure PreWatDroMai4 "Pressure drop 4 across the main pipe";

  parameter Modelica.SIunits.Pressure PreWatDroBra1 "Pressure drop 1 across the pipe branch 1";

  parameter Modelica.SIunits.Pressure PreWatDroBra2 "Pressure drop 1 across the pipe branch 2";

  parameter Modelica.SIunits.Pressure PreWatDroBra3 "Pressure drop 1 across the pipe branch 3";

  parameter Modelica.SIunits.Pressure PreWatDroBra4 "Pressure drop 1 across the pipe branch 4";

  parameter Modelica.SIunits.Pressure PreWatDroBra5 "Pressure drop 1 across the pipe branch 5";
  ...
  parameter Modelica.SIunits.MassFlowRate mWatFloRat1 "mass flow rate for vav 1";

  parameter Modelica.SIunits.MassFlowRate mWatFloRat2 "mass flow rate for vav 2";

  parameter Modelica.SIunits.MassFlowRate mWatFloRat3 "mass flow rate for vav 3";

  parameter Modelica.SIunits.MassFlowRate mWatFloRat4 "mass flow rate for vav 4";

  parameter Modelica.SIunits.MassFlowRate mWatFloRat5 "mass flow rate for vav 5";


  parameter Modelica.SIunits.Pressure PreDroAir1 "Pressure drop in the air side of vav 1";
  parameter Modelica.SIunits.Pressure PreDroWat1 "Pressure drop in the water side of vav 1";
  ...
  parameter Modelica.SIunits.Pressure PreDroWat2 "Pressure drop in the water side of vav 2";
  ...
  parameter Modelica.SIunits.Pressure PreDroWat3 "Pressure drop in the water side of vav 3";
  ...
  parameter Modelica.SIunits.Pressure PreDroWat4 "Pressure drop in the water side of vav 4";
  parameter Modelica.SIunits.Efficiency eps4(max=1) = 0.8
    "Heat exchanger effectiveness of vav 4";

  parameter Modelica.SIunits.Pressure PreDroAir5 "Pressure drop in the air side of vav 5";
  parameter Modelica.SIunits.Pressure PreDroWat5 "Pressure drop in the water side of vav 5";
