...
model FloorDX
  ...
  parameter Modelica.SIunits.Time minOffTim(min=0) = 900
      "Minimum off time";
  ...
  parameter Modelica.SIunits.MassFlowRate mAirFloRat1 = 2.72 "mass flow rate for vav 1";

  parameter Modelica.SIunits.MassFlowRate mAirFloRat2 = 0.82 "mass flow rate for vav 2";

  parameter Modelica.SIunits.MassFlowRate mAirFloRat3 = 0.63 "mass flow rate for vav 3";

  parameter Modelica.SIunits.MassFlowRate mAirFloRat4 = 0.78 "mass flow rate for vav 4";

  parameter Modelica.SIunits.MassFlowRate mAirFloRat5 = 1.56 "mass flow rate for vav 5";
  ...
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal1 = 1200
    "rated heat flow rate for heating of vav 1";
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal2 = 4500
    "rated heat flow rate for heating of vav 2";
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal3 = 6700
    "rated heat flow rate for heating of vav 3";
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal4 = 4500
    "rated heat flow rate for heating of vav 4";
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal5 = 4500
