...
model DualFanAirHanUnitDX
  ...
  parameter Modelica.SIunits.MassFlowRate mAirFloRat = 1.2*0.944 "mass flow rate for air";
  ...
  parameter Modelica.SIunits.MassFlowRate mFreAirFloRat = 1.2*0.944*0.5 "mass flow rate for fresh air";
