...
model MultiBoilers
 ...
 package MediumHW =
  ...
  parameter Modelica.SIunits.MassFlowRate mHW_flow_nominal[:] = {10,10}
  ...
  .BuildingControlEmulator.Subsystems.Boiler.MultiBoilers mulBoiSys(
    ...
    eta=eta,
    THW_start=THW,
    n=2) annotation (Placement(transformation(extent={{-20,-36},{0,-16}})));
  ...
  IBPSA.Fluid.Sources.MassFlowSource_T souHW(
    use_T_in=true,
  ...
  IBPSA.Fluid.Sources.Boundary_pT sinHW(redeclare package Medium = MediumHW, nPorts=1) "Sink for CHW"
    annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={70,-50})));
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTHWLeaBoi(
    redeclare package Medium = MediumHW,
