...
model MultiBoilers
  ...
  parameter Modelica.SIunits.Temperature THW_start
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTHWEntChi(
    ...
    m_flow_nominal=sum(mHW_flow_nominal)) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={50,80})));
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTHWLeaChi(
    allowFlowReversal=true,
    redeclare package Medium = MediumHW,
