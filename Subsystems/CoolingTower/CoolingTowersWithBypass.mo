...
model CoolingTowersWithBypass
  ...
  parameter Modelica.SIunits.Temperature TCWLowSet
    "The lower temperatre limit of condenser water entering the chiller plant";
  parameter Modelica.SIunits.Power P_nominal[n] "Nominal tower power (at y=1)";
  ...
  replaceable IBPSA.Fluid.Sensors.TemperatureTwoPort senTCWEntChi(
