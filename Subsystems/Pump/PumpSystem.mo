...
model PumpSystem "This model is used to simulate the secondary chilled water pump"
  ...
  parameter Modelica.SIunits.MassFlowRate m_flow_nominal[n];
  ...
  parameter Modelica.SIunits.VolumeFlowRate VolFloCur[n,:] "Volume flow rate curve";
  parameter Modelica.SIunits.Pressure PreCur[n,:] "Pressure curve";
  ...
  IBPSA.Fluid.Actuators.Valves.TwoWayEqualPercentage val[n](redeclare package
      Medium =                                                                         Medium,
