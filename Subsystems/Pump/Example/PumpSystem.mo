...
model PumpSystem
  ...
  parameter Modelica.SIunits.VolumeFlowRate VolFloCur[3,:]={{5/1000,10/1000,20/1000},{5/1000,10/1000,20/1000},{5/1000,10/1000,20/1000}} "Volume flow rate curve";
  parameter Modelica.SIunits.Pressure PreCur[3,:]= {{8000,6000,4000},{8000,6000,4000},{8000,6000,4000}} "Pressure curve";
