...
equation
  ...
  connect(realExpression2.y, TZonSen[2]) annotation (Line(points={{71,62},{86,62},
          {86,36},{110,36}}, color={0,0,127}));
  connect(realExpression3.y, TZonSen[3]) annotation (Line(points={{71,42},{90,42},
          {90,40},{110,40}}, color={0,0,127}));
  connect(realExpression4.y, TZonSen[4]) annotation (Line(points={{71,22},{82,22},
          {82,44},{110,44}}, color={0,0,127}));
  connect(realExpression5.y, TZonSen[5]) annotation (Line(points={{73,0},{80,0},{
          80,48},{110,48}}, color={0,0,127}));
