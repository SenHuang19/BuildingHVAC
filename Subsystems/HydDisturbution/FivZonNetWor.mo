...
model FivZonNetWor
  ...
  parameter Modelica.SIunits.Pressure PreDroMai1 "Pressure drop 1 across the duct";

  parameter Modelica.SIunits.Pressure PreDroMai2 "Pressure drop 2 across the main duct";

  parameter Modelica.SIunits.Pressure PreDroMai3 "Pressure drop 3 across the main duct";

  parameter Modelica.SIunits.Pressure PreDroMai4 "Pressure drop 4 across the main duct";

  parameter Modelica.SIunits.Pressure PreDroBra1 "Pressure drop 1 across the duct branch 1";

  parameter Modelica.SIunits.Pressure PreDroBra2 "Pressure drop 1 across the duct branch 2";

  parameter Modelica.SIunits.Pressure PreDroBra3 "Pressure drop 1 across the duct branch 3";

  parameter Modelica.SIunits.Pressure PreDroBra4 "Pressure drop 1 across the duct branch 4";

  parameter Modelica.SIunits.Pressure PreDroBra5 "Pressure drop 1 across the duct branch 5";

  parameter Modelica.SIunits.MassFlowRate mFloRat1 "mass flow rate for the first branch1";

  parameter Modelica.SIunits.MassFlowRate mFloRat2 "mass flow rate for the first branch2";

  parameter Modelica.SIunits.MassFlowRate mFloRat3 "mass flow rate for the first branch3";

  parameter Modelica.SIunits.MassFlowRate mFloRat4 "mass flow rate for the first branch4";

  parameter Modelica.SIunits.MassFlowRate mFloRat5 "mass flow rate for the first branch5";

  IBPSA.Fluid.FixedResistances.Junction junSup1(m_flow_nominal={mFloRat1 + mFloRat2 + mFloRat3 + mFloRat4 + mFloRat5,-mFloRat2-mFloRat3-mFloRat4 - mFloRat5,-
        mFloRat1}, redeclare package Medium = Medium,
    dp_nominal={PreDroMai1/2,PreDroMai2/2,PreDroBra1/2})
    annotation (Placement(transformation(extent={{-90,30},{-70,50}})));
  IBPSA.Fluid.FixedResistances.Junction junRet1(redeclare package Medium = Medium, m_flow_nominal={mFloRat2 + mFloRat3 + mFloRat4 + mFloRat5,-mFloRat1-mFloRat2-mFloRat3-
        mFloRat4 - mFloRat5,mFloRat1},
    dp_nominal={PreDroMai2/2,PreDroMai1/2,PreDroBra1/2})
                                                annotation (Placement(transformation(extent={{-70,-70},{-90,-50}})));
  IBPSA.Fluid.FixedResistances.Junction junRet2( redeclare package Medium = Medium, m_flow_nominal={mFloRat3 + mFloRat4 + mFloRat5,-mFloRat2-mFloRat3-
        mFloRat4 - mFloRat5,mFloRat2},
    dp_nominal={PreDroMai3/2,PreDroMai2/2,PreDroBra2/2})
                                                annotation (Placement(transformation(extent={{-30,-70},{-50,-50}})));
  IBPSA.Fluid.FixedResistances.Junction junSup2(m_flow_nominal={mFloRat2 + mFloRat3 + mFloRat4 + mFloRat5,-mFloRat3-mFloRat4 - mFloRat5,-
        mFloRat2}, redeclare package Medium = Medium,
    dp_nominal={PreDroMai2/2,PreDroMai3/2,PreDroBra2/2})
                      annotation (Placement(transformation(extent={{-50,30},{-30,50}})));
  IBPSA.Fluid.FixedResistances.Junction junSup3(m_flow_nominal={mFloRat3 + mFloRat4 + mFloRat5,-mFloRat4 - mFloRat5,-
        mFloRat3}, redeclare package Medium = Medium,
    dp_nominal={PreDroMai3/2,PreDroMai4/2,PreDroBra3/2})
                                                annotation (Placement(transformation(extent={{-10,30},{10,50}})));
  IBPSA.Fluid.FixedResistances.Junction junRet3(redeclare package Medium = Medium, m_flow_nominal={mFloRat4 + mFloRat5,-mFloRat3-
        mFloRat4 - mFloRat5,mFloRat3},
    dp_nominal={PreDroMai4/2,PreDroMai3/2,PreDroBra3/2})
                                                annotation (Placement(transformation(extent={{10,-50},{-10,-70}})));
  IBPSA.Fluid.FixedResistances.Junction junSup4(m_flow_nominal={mFloRat4 + mFloRat5,-mFloRat5,-mFloRat4}, redeclare
      package
      Medium = Medium,
    dp_nominal={PreDroMai4/2,PreDroBra5/2,PreDroBra4/2})
                                                annotation (Placement(transformation(extent={{30,30},{50,50}})));
  IBPSA.Fluid.FixedResistances.Junction junRet4(redeclare package Medium = Medium, m_flow_nominal={mFloRat5,-mFloRat4 - mFloRat5,
        mFloRat4},
  ...
  replaceable IBPSA.Fluid.Sensors.Pressure         senRelPre(redeclare package Medium = Medium)
