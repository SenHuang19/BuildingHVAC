...
model FivZonVAVDX
  ...
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal1 = 10.92*1000*20*1.2
    "rated heat flow rate for heating of vav 1";

  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal2 =  2.25*1.2*1000*20
    "rated heat flow rate for heating of vav 2";

  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal3 = 1.49*1.2*1000*20
    "rated heat flow rate for heating of vav 3";

  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal4 = 1.9*1.2*1000*20
    "rated heat flow rate for heating of vav 4";

  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal5 = 1.73*1.2*1000*20
  ...
  parameter Modelica.SIunits.Pressure PreDroAir2 = 124 "Pressure drop in the air side of vav 2";
