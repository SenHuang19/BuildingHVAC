...
model FivZonNetWorwithCon
  ...
  parameter Modelica.SIunits.MassFlowRate mAirFloRat = 1 "mass flow rate for the first branch1";

  parameter Modelica.SIunits.Pressure PreDroMai1 = 100 "Pressure drop 1 across the duck";

  parameter Modelica.SIunits.Pressure PreDroMai2 = 100 "Pressure drop 2 across the main duct";

  parameter Modelica.SIunits.Pressure PreDroMai3 = 100 "Pressure drop 3 across the main duct";

  parameter Modelica.SIunits.Pressure PreDroMai4 = 100 "Pressure drop 4 across the main duct";

  parameter Modelica.SIunits.Pressure PreDroBra = 50 "Pressure drop across the duct branch";
  ...
  Modelica.Blocks.Sources.Ramp ramp1[
                                    5](duration=86400, height=load*100)
