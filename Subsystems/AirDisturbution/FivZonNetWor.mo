...
model FivZonNetWor
  ...
  IBPSA.Fluid.FixedResistances.Junction jun annotation (Placement(transformation(extent={{-90,30},{-70,50}})));
  IBPSA.Fluid.FixedResistances.Junction jun1 annotation (Placement(transformation(extent={{-70,-50},{-90,-70}})));
  IBPSA.Fluid.FixedResistances.Junction jun2 annotation (Placement(transformation(extent={{-34,-50},{-54,-70}})));
  IBPSA.Fluid.FixedResistances.Junction jun3 annotation (Placement(transformation(extent={{-52,30},{-32,50}})));
  IBPSA.Fluid.FixedResistances.Junction jun4 annotation (Placement(transformation(extent={{-10,30},{10,50}})));
  IBPSA.Fluid.FixedResistances.Junction jun5 annotation (Placement(transformation(extent={{8,-50},{-12,-70}})));
  IBPSA.Fluid.FixedResistances.Junction jun6 annotation (Placement(transformation(extent={{30,30},{50,50}})));
  IBPSA.Fluid.FixedResistances.Junction jun7 annotation (Placement(transformation(extent={{50,-50},{30,-70}})));
  ...
  IBPSA.Fluid.Sensors.RelativePressure senRelPre annotation (Placement(transformation(extent={{50,70},{30,90}})));
