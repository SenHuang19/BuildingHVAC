...
package Chiller
  ...
  model MultiChillers
    ...
    IBPSA.Fluid.Sensors.TemperatureTwoPort senTCHWEntChi(
      ...
      m_flow_nominal=sum(mCHW_flow_nominal))
          ...
          rotation=0,
          origin={50,80})));
    IBPSA.Fluid.Sensors.TemperatureTwoPort senTCWLeaChi(
      allowFlowReversal=true,
      ...
      m_flow_nominal=sum(mCW_flow_nominal))
          ...
          rotation=0,
          origin={-82,80})));
    IBPSA.Fluid.Sensors.TemperatureTwoPort senTCHWLeaChi(
      allowFlowReversal=true,
      redeclare package Medium = MediumCHW,
      T_start=TCHW_start,
      m_flow_nominal=sum(mCHW_flow_nominal))
          ...
          rotation=0,
          origin={52,-80})));
    IBPSA.Fluid.Sensors.TemperatureTwoPort senTCWEntChi(
      allowFlowReversal=true,
      redeclare package Medium = MediumCW,
      T_start=TCW_start,
      m_flow_nominal=sum(mCW_flow_nominal))
          ...
          rotation=0,
          origin={-70,-80})));
    replaceable Devices.WaterSide.Chiller ch[n](
    ...
    IBPSA.Fluid.Sensors.MassFlowRate senMasFloCHW(redeclare package Medium =
          MediumCHW)
      annotation (Placement(transformation(extent={{70,-90},{88,-70}})));
    IBPSA.Fluid.Sensors.MassFlowRate senMasFloCW(redeclare package Medium =
          MediumCHW)
...
First implementation.
  ...
  model MultiHeterChillers "The chiller system with N heterogeneous chillers"
    ...
    parameter Modelica.SIunits.Pressure dPCW_nominal
      "Pressure difference at the condenser water wide";
    parameter Modelica.SIunits.MassFlowRate mCHW_flow_nominal[n+m]
      "Nominal mass flow rate at the chilled water side";
...
First implementation.
  ...
  extends Modelica.Icons.ExamplesPackage;
    ...
    model MultiChillers "Test model for MultiChillerSystem"
      ...
      package MediumCHW = IBPSA.Media.Water "Medium model";
      package MediumCW = IBPSA.Media.Water "Medium model";
      ...
      parameter Modelica.SIunits.MassFlowRate mCHW_flow_nominal[:] = {-datChi[1].QEva_flow_nominal/4200/5.56 for i in linspace(1, 3, 3)}
        "Nominal mass flow rate at the chilled water side";
      parameter Modelica.SIunits.MassFlowRate mCW_flow_nominal[:] = {mCHW_flow_nominal[1]*(datChi[1].COP_nominal+1)/datChi[1].COP_nominal for i in linspace(1, 3, 3)}
        "Nominal mass flow rate at the condenser water wide";
      ...
      IBPSA.Fluid.Sources.Boundary_pT sinCW(redeclare package Medium =
