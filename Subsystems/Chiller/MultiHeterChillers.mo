within BuildingControlEmulator.Subsystems.Chiller;
model MultiHeterChillers "The chiller system with N heterogeneous chillers"
  ...
  parameter Modelica.SIunits.MassFlowRate mCHW_flow_nominal[n]
    "Nominal mass flow rate at the chilled water side";
  parameter Modelica.SIunits.MassFlowRate mCW_flow_nominal[n]
