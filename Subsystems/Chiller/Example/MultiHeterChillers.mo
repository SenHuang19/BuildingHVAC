within BuildingControlEmulator.Subsystems.Chiller.Example;
model MultiHeterChillers "Test model for MultiChillerSystem"
  ...
  BuildingControlEmulator.Subsystems.Chiller.MultiHeterChillers
                             mulChiSys(
  ...
  IBPSA.Fluid.Sources.FixedBoundary sinCW(redeclare package Medium =
  ...
  IBPSA.Fluid.Sources.FixedBoundary sinCHW(redeclare package Medium =
