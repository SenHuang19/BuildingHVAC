...
model MixingBox
  ...
  parameter Modelica.SIunits.Temperature TemHig "highest temeprature when the economizer is on";
  parameter Modelica.SIunits.Temperature TemLow "lowest temeprature when the economizer is on";
...
equation
  ...
  connect(ecoCon.On, On) annotation (Line(
      ...
      color={255,0,255},
      pattern=LinePattern.Dash));
  connect(ecoCon.y, mixBox.DamPos) annotation (Line(
      points={{-49,40},{-40,40},{-40,12},{-54,12},{-54,1},{-34,1}},
      color={0,0,127},
      pattern=LinePattern.Dash));
