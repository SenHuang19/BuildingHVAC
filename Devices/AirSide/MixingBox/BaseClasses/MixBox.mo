...
model MixBox
  ...
  parameter Modelica.SIunits.Pressure PreDro "Pressure drop in the air side";
  parameter Modelica.SIunits.MassFlowRate mFreAirFloRat "mass flow rate for fresh air";
  parameter Modelica.SIunits.MassFlowRate mTotAirFloRat "mass flow rate for water";
  ...
  replaceable IBPSA.Fluid.Actuators.Valves.TwoWayEqualPercentage valExh(
    redeclare package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-70,50})));
  replaceable IBPSA.Fluid.Actuators.Valves.TwoWayEqualPercentage valFre(
    redeclare package Medium = Medium,
    m_flow_nominal=mFreAirFloRat,
    dpValve_nominal=PreDro/2)
    annotation (Placement(transformation(
  ...
  replaceable IBPSA.Fluid.Sensors.TemperatureTwoPort temOut(redeclare package Medium = Medium,
      m_flow_nominal=mFreAirFloRat)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={60,82})));
  replaceable IBPSA.Fluid.Sensors.TemperatureTwoPort temMix(redeclare package Medium =
  ...
  replaceable IBPSA.Fluid.Actuators.Valves.TwoWayEqualPercentage valRet(
    redeclare package Medium = Medium,
    dpValve_nominal=PreDro/2,
