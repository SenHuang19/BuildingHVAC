...
model VAV_advance_temp_sensor
  ...
  parameter Modelica.SIunits.MassFlowRate mWatFloRat "mass flow rate for air";
  ...
  IBPSA.Fluid.Actuators.Valves.TwoWayEqualPercentage Dam(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort temLea(
  ...
  IBPSA.Fluid.Actuators.Valves.TwoWayEqualPercentage ReheaVal(
