...
model VAV
  ...
  parameter Modelica.SIunits.MassFlowRate mAirFloRat = 3 "mass flow rate for air";
  parameter Modelica.SIunits.MassFlowRate mWatFloRat = mAirFloRat*0.3*(308.15 - 288.15)/4.2/(333.15 - 323.15) "mass flow rate for air";
  parameter Modelica.SIunits.Pressure PreDroAir = 100 "Pressure drop in the air side";
  parameter Modelica.SIunits.Pressure PreDroWat = 1000 "Pressure drop in the water side";
