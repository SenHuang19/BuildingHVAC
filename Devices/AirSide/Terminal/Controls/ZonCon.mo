...
model ZonCon
  ...
  IBPSA.Controls.Continuous.LimPID cooCon(
  ...
  IBPSA.Controls.Continuous.LimPID heaCon(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    Ti=60,
    k=0.01,
    reverseActing=true)
  ...
  IBPSA.Utilities.IO.SignalExchange.Overwrite oveTCooSet
    annotation (Placement(transformation(extent={{-80,50},{-60,70}})));
  IBPSA.Utilities.IO.SignalExchange.Overwrite oveTHeaSet
    annotation (Placement(transformation(extent={{-96,-64},{-88,-56}})));
  IBPSA.Utilities.IO.SignalExchange.Read TZon
    annotation (Placement(transformation(extent={{-92,-10},{-72,10}})));
  IBPSA.Utilities.IO.SignalExchange.Read TCooSet
