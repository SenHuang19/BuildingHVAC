...
model PreSensorDrift
  ...
  parameter Modelica.SIunits.Pressure dp = 0 "Constant deviation of pressure measurement";
  parameter Modelica.SIunits.Time FauTime = 0 "Time when faults start to occur";
  parameter Modelica.SIunits.Time DraftTime = 0 "Length of the drift period";
