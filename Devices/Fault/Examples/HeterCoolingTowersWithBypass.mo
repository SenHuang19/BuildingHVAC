...
model HeterCoolingTowersWithBypass
  ...
  parameter Modelica.SIunits.Power P_nominal[:] = {30000 for i in linspace(1,3,3)} "Nominal power (at y=1)";
  ...
  parameter Modelica.SIunits.MassFlowRate mCW_flow_nominal[:]={10 for i in linspace(1,3,3)}
