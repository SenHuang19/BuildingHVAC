...
model Building "Simple model to simulate the demind side of the loop"
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTLeaPri(redeclare package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
    annotation (Placement(transformation(extent={{-80,10},{-60,-10}})));
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTEntPri(redeclare package
      Medium = Medium, m_flow_nominal=m_flow_nominal)
  ...
  parameter Modelica.SIunits.Volume V = 10
    "Volume of water in the secondary loop";


  IBPSA.Fluid.Sensors.MassFlowRate senMasFloCHWSec(redeclare package Medium =
        Medium)
  ...
  replaceable IBPSA.Fluid.Sensors.RelativePressure senRelPre(redeclare package Medium =
