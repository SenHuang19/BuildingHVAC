within BuildingControlEmulator.Devices.WaterSide.BaseClasses;
partial model PartialElectric "Partial model for electric chiller"
  ...
  parameter Modelica.SIunits.Efficiency epsEva(max=1) = 1
    "Heat exchanger effectiveness at evaporator";

  parameter Modelica.SIunits.Efficiency epsCon(max=1) = 1
