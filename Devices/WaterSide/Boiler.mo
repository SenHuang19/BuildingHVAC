...
model Boiler "Boiler"
  ...
  replaceable IBPSA.Fluid.Sensors.TemperatureTwoPort senTHWLea(
  ...
  IBPSA.Fluid.Sensors.TemperatureTwoPort senTHWEnt(
    ...
    m_flow_nominal=mHW_flow_nominal) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={30,0})));
  IBPSA.Fluid.Sensors.MassFlowRate senMasFloHW(redeclare package Medium =
        MediumHW)
  ...
  IBPSA.Fluid.Sensors.Pressure senPreHWLea(redeclare package Medium =
        MediumHW)
    annotation (Placement(transformation(extent={{78,-50},{98,-30}})));
  Modelica.Blocks.Math.RealToBoolean realToBoolean
    annotation (Placement(transformation(extent={{-70,-18},{-54,-2}})));
  .BuildingControlEmulator.Devices.Control.conPI conPI(Ti=2400, k=1)
